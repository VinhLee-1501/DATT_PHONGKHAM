                    ...
                    <div class="modal-body">
                        <form>
                            <div class="mb-3">
                                <label for="recipient-name" class="col-form-label">Thời gian khám:</label>
                                <input type="date" name="day" class="form-control" id="daySelect" value="">
                                <input type="hidden" name="shift_id" class="form-control" id="shift_id" value="">
                            </div>
                            <div class="col-md-12 row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="" class="col-form-label">Bác sĩ:</label>
                                        <select class="form-control" id="usernameEdit" name="user_id" readonly></select>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="check" id="cancelstatusCheckEdit">
                                <label class="form-check-label" for="cancelstatus-check">
                                    Xác nhận
                                </label>
                            </div>
